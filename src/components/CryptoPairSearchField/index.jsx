  ...
  return (
    <div className={styles.container}>
        <div className={styles.row}>
          <Tooltip title={tooltipText("first")} TransitionComponent={Zoom} arrow>
            <TextField
              id="pairOne"
              label="Pair 1"
              variant="outlined"
          ...
          <Tooltip title={tooltipText("second")} TransitionComponent={Zoom} arrow>
            <TextField
              id="pairTwo"
              label="Pair 2"
              variant="outlined"
          ...
          <Tooltip title="Press to search" TransitionComponent={Zoom} arrow>
            <Fab
              color="primary"
              variant="extended"
